...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public void stopUsingItem()
    {
        ...
        {
        	PlayerUseItemEvent.Stop event = new PlayerUseItemEvent.Stop(this, itemInUse, itemInUseCount);
    ...
    public void onUpdate()
    {
        ...
        if (this.itemInUse != null)
        {
            ...
            {
            	PlayerUseItemEvent.Tick event = new PlayerUseItemEvent.Tick(this, itemInUse, itemInUseCount);
            	itemInUseCount = PitClient.EVENT_BUS.post(event) ? -1 : event.duration;
    ...
    protected void onItemUseFinish()
    {
        if (this.itemInUse != null)
        {
            ...
            PlayerUseItemEvent.Finish event = new PlayerUseItemEvent.Finish(this, itemInUse, itemInUseCount, itemstack);
            PitClient.EVENT_BUS.post(event);
    ...
    {
    	AttackEntityEvent event = new AttackEntityEvent(this, targetEntity);
    ...
    public void setItemInUse(ItemStack stack, int duration)
    {
        ...
        {
        	PlayerUseItemEvent.Start event = new PlayerUseItemEvent.Start(this, stack, duration);
        	duration = PitClient.EVENT_BUS.post(event) ? -1 : event.duration;
