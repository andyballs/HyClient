...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new GuiSessionMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new GuiSessionMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new GuiSessionMainMenu();
        }
    ...
    private void runGameLoop() throws IOException
    {
        ...
        {
        	PitClient.EVENT_BUS.post(new TickEvent.RenderTickEvent(Phase.START, this.timer.renderPartialTicks));
            this.mcProfiler.endStartSection("gameRenderer");
            this.entityRenderer.func_181560_a(this.timer.renderPartialTicks, i);
            this.mcProfiler.endSection();
            PitClient.EVENT_BUS.post(new TickEvent.RenderTickEvent(Phase.END, this.timer.renderPartialTicks));
        }
    ...
    public void rightClickMouse()
    {
        if (!this.playerController.func_181040_m())
        {
                ...
                switch (this.objectMouseOver.typeOfHit)
                {
                    ...
                    case BLOCK:
                        ...
                        if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air)
                        {
                            ...
                            PlayerInteractEvent event = new PlayerInteractEvent(this.thePlayer, Action.RIGHT_CLICK_BLOCK, blockpos, this.objectMouseOver.sideHit, this.theWorld, this.objectMouseOver.hitVec);
            ...
            if (flag)
            {
                ...
                PlayerInteractEvent event = new PlayerInteractEvent(thePlayer, Action.RIGHT_CLICK_AIR, null, objectMouseOver.sideHit, theWorld, null);
                boolean res = !PitClient.EVENT_BUS.post(event);
                if (res && itemstack1 != null && this.playerController.sendUseItem(this.thePlayer, this.theWorld, itemstack1))
                {
    ...
    {
    	PitClient.EVENT_BUS.post(new TickEvent.ClientTickEvent(Phase.START));
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Mouse.next())
            {
                ...
                PitClient.EVENT_BUS.post(new InputEvent.MouseInputEvent());
            }
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
             	...
             	PitClient.EVENT_BUS.post(new InputEvent.KeyInputEvent());
            }
        ...
        PitClient.EVENT_BUS.post(new TickEvent.ClientTickEvent(Phase.END));
    ...
    {
        this.gameSettings.keyBindings = ArrayUtils.add(this.gameSettings.keyBindings, key);
    }
}
