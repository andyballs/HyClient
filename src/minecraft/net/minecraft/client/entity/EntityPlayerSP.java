...
public class EntityPlayerSP extends AbstractClientPlayer
{
	...
	{
		MotionEvent event = new MotionEvent.Pre(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
		...
		PitClient.EVENT_BUS.post(new MotionEvent.Post(event.x, event.y, event.z, event.yaw, event.pitch, event.onGround));
	}
	...
	public void onLivingUpdate()
	{
		...
		{
			NoSlowdownEvent event = new NoSlowdownEvent();
			PitClient.EVENT_BUS.post(event);
