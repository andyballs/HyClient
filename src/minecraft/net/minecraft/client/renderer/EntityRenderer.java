...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    protected float clipDistance = 128.0F;
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
    		...
    		for (Module mod : PitClient.moduleManager.getEnabledModules()) {
    			mod.onMouseOver(partialTicks);
    		}
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                GlStateManager.rotate(PitClient.freeLook.getYaw() + (PitClient.freeLook.getYaw() - PitClient.freeLook.getYaw()) * partialTicks + 180.0F, 0.0F, -1.0F, 0.0F);
                GlStateManager.rotate(PitClient.freeLook.getPitch() + (PitClient.freeLook.getPitch() - PitClient.freeLook.getPitch()) * partialTicks, -1.0F, 0.0F, 0.0F);
            }
        }
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            {
                float f1 = PitClient.freeLook.getYaw();
                float f2 = PitClient.freeLook.getPitch();
                ...
                GlStateManager.rotate(PitClient.freeLook.getPitch() - f2, 1.0F, 0.0F, 0.0F);
                GlStateManager.rotate(PitClient.freeLook.getYaw() - f1, 0.0F, 1.0F, 0.0F);
                GlStateManager.translate(0.0F, 0.0F, (float)(-d3));
                GlStateManager.rotate(f1 - PitClient.freeLook.getYaw(), 0.0F, 1.0F, 0.0F);
                GlStateManager.rotate(f2 - PitClient.freeLook.getPitch(), 1.0F, 0.0F, 0.0F);
            }
        }
        else
        {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                float f6 = PitClient.freeLook.getYaw() + (PitClient.freeLook.getYaw() - PitClient.freeLook.getYaw()) * partialTicks + 180.0F;
                float f7 = PitClient.freeLook.getPitch() + (PitClient.freeLook.getPitch() - PitClient.freeLook.getPitch()) * partialTicks;
                float f8 = 0.0F;
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_)
    {
        ...
        if (this.mc.inGameHasFocus && flag && PitClient.freeLook.overrideMouse())
        {
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        PitClient.EVENT_BUS.post(new RenderWorldLastEvent(renderglobal, partialTicks));
     ...
     */
    protected void setupFog(int p_78468_1_, float partialTicks)
    {
        Entity entity = this.mc.getRenderViewEntity();
        boolean flag = false;
