...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    {
    	RenderPlayerEvent event = new RenderPlayerEvent.Pre(entity, this, partialTicks, x, y, z);
        ...
        if (!entity.isUser() || this.renderManager.livingPlayer == entity)
        {
       	...
       	PitClient.EVENT_BUS.post( new RenderPlayerEvent.Post(entity, this, partialTicks, x, y, z));
    }
