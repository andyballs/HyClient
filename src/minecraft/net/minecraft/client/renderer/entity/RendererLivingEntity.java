...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
        	RenderLivingEvent.Pre event = new RenderLivingEvent.Pre(entity, this, x, y, z);
            ...
            PitClient.EVENT_BUS.post(new RenderLivingEvent.Post(entity,this,x,y,z));
        }
    }
    ...
    public void renderName(T entity, double x, double y, double z)
    {
        ...
        {
        	RenderLivingEvent.Specials event = new RenderLivingEvent.Specials.Pre(entity, this, x, y, z);
        	if (PitClient.EVENT_BUS.post(event)) return;
            if (this.canRenderName(entity))
            {
           	...
           	PitClient.EVENT_BUS.post(new RenderLivingEvent.Specials.Post(entity, this, x, y, z));
        }
    }
