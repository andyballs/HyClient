...
import rage.pitclient.events.GuiScreenEvent;
...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    {
    	if (PitClient.EVENT_BUS.post(new GuiScreenEvent.DrawScreenEvent.Pre(this, mouseX, mouseY, partialTicks))) return;
        ...
        PitClient.EVENT_BUS.post(new GuiScreenEvent.DrawScreenEvent.Post(this, mouseX, mouseY, partialTicks));
    }
    ...
    {
        if (PitClient.commandManager.executeCommand(mc.thePlayer, msg) != 0) return; //RagePit
        if (addToChat)
        {
        ...
        if (mouseButton == 0)
        {
            for (int i = 0; i < this.buttonList.size(); ++i)
            {
                ...
                if (guibutton.mousePressed(this.mc, mouseX, mouseY))
                {
                	...
                	if (PitClient.EVENT_BUS.post(event)) break;
                	
                    this.selectedButton = guibutton;
                    guibutton.playPressSound(this.mc.getSoundHandler());
                    this.actionPerformed(guibutton);
                    if (this.equals(this.mc.currentScreen))
                        PitClient.EVENT_BUS.post(new GuiScreenEvent.ActionPerformedEvent.Post(this, event.button, this.buttonList));
                }
            }
        }
    }
    ...
    public void setWorldAndResolution(Minecraft mc, int width, int height)
    {
        ...
        this.width = width;
        this.height = height;
        if (!PitClient.EVENT_BUS.post(new GuiScreenEvent.InitGuiEvent.Pre(this, this.buttonList)))
        {
        this.buttonList.clear();
        this.initGui();
        }
        PitClient.EVENT_BUS.post(new GuiScreenEvent.InitGuiEvent.Post(this, this.buttonList));
    }
    ...
    public void handleInput() throws IOException
    {
        if (Mouse.isCreated())
        {
            while (Mouse.next())
            {
                if (PitClient.EVENT_BUS.post(new GuiScreenEvent.MouseInputEvent.Pre(this))) continue;
                this.handleMouseInput();
                if (this.equals(this.mc.currentScreen)) PitClient.EVENT_BUS.post(new GuiScreenEvent.MouseInputEvent.Post(this));
            }
        }
        ...
        if (Keyboard.isCreated())
        {
            while (Keyboard.next())
            {
                if (PitClient.EVENT_BUS.post(new GuiScreenEvent.KeyboardInputEvent.Pre(this))) continue;
                this.handleKeyboardInput();
                if (this.equals(this.mc.currentScreen)) PitClient.EVENT_BUS.post(new GuiScreenEvent.KeyboardInputEvent.Post(this));
            }
        }
    }
    ...
    public void drawDefaultBackground()
    {
        ...
        PitClient.EVENT_BUS.post(new GuiScreenEvent.BackgroundDrawnEvent(this));
    }
