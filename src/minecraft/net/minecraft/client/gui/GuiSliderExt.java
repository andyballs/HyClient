 ...
 * @author iChun
 */
public class GuiSliderExt extends GuiButtonExt
{
    ...
    public GuiSliderExt(int id, int xPos, int yPos, int width, int height, String prefix, String suf, double minVal, double maxVal, double currentVal, boolean showDec, boolean drawStr)
    {
    ...
    public GuiSliderExt(int id, int xPos, int yPos, String displayStr, double minVal, double maxVal, double currentVal, ISlider par)
    {
    ...
    {
        void onChangeSliderValue(GuiSliderExt slider);
    }
}