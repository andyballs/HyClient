...
public class GuiIngame extends Gui
{
    ...
    public void renderScoreboard(ScoreObjective objective, ScaledResolution sr)
    {
    ...
    public void renderPumpkinOverlay(ScaledResolution p_180476_1_)
    {
        GlStateManager.disableDepth();
     ...
     */
    public void renderVignette(float p_180480_1_, ScaledResolution p_180480_2_)
    {
        if (!Config.isVignetteEnabled())
        {
            GlStateManager.enableDepth();
