...
public class NetHandlerPlayServer implements INetHandlerPlayServer, ITickable
{
    ...
    public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn)
    {
        ...
        if (packetIn.getPlacedBlockDirection() == 255)
        {
            ...
            PlayerInteractEvent event = new PlayerInteractEvent(this.playerEntity, Action.RIGHT_CLICK_AIR, BlockPos.ORIGIN, null, worldserver, new Vec3(packetIn.getPlacedBlockOffsetX(), packetIn.getPlacedBlockOffsetY(), packetIn.getPlacedBlockOffsetZ()));
            if (!PitClient.EVENT_BUS.post(event)) this.playerEntity.theItemInWorldManager.tryUseItem(this.playerEntity, worldserver, itemstack);
        }
