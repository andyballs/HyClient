...
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.AIR;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.ALL;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.ARMOR;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.BOSSHEALTH;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.CHAT;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.CROSSHAIRS;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.DEBUG;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.EXPERIENCE;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.FOOD;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.HEALTH;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.HEALTHMOUNT;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.HELMET;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.HOTBAR;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.JUMPBAR;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.PLAYER_LIST;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.PORTAL;
import static rage.pitclient.events.RenderGameOverlayEvent.ElementType.TEXT;
...
public class CustomGuiIngame extends GuiIngame
{
    ...
    protected void renderArmor(int width, int height)
    {
        ...
        int level = getTotalArmorValue(mc.thePlayer);
    ...
    protected void renderHUDText(int width, int height)
    {
        ...
        if (!PitClient.EVENT_BUS.post(event))
        {
            int top = 2;
    ...
    protected void renderChat(int width, int height)
    {
        ...
        if (PitClient.EVENT_BUS.post(event)) return;
    ...
    {
    	RenderGameOverlayEvent.Pre event = new RenderGameOverlayEvent.Pre(eventParent, type);
        return PitClient.EVENT_BUS.post(event);
    }
    private void post(ElementType type)
    {
    	PitClient.EVENT_BUS.post(new RenderGameOverlayEvent.Post(eventParent, type));
    }
